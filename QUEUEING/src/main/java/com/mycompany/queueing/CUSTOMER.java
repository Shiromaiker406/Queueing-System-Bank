...
public class CUSTOMER extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        main.add(jLabel3);
        jLabel3.setBounds(400, 190, 28, 16);

        container.add(main, "main");

        BP.setLayout(null);

        paytoOptions.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Meralco", "Water", "Load" }));
        BP.add(paytoOptions);
        ...
        BP.add(jLabel1);
        jLabel1.setBounds(20, 170, 34, 16);

        jLabel2.setText("AMOUNT");
        BP.add(jLabel2);
        jLabel2.setBounds(420, 170, 50, 16);
        ...
        APLI.add(address);
        address.setBounds(110, 250, 270, 40);
        ...
        APLI.add(occupation);
        occupation.setBounds(490, 140, 270, 40);
        ...
        queuenum.setFont(new java.awt.Font("Myanmar Text", 1, 14)); // NOI18N
        queuenum.setForeground(new java.awt.Color(255, 51, 51));
        queuenum.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        queue.add(queuenum);
        queuenum.setBounds(137, 96, 510, 190);
        queue.add(queuebg);
